class VenuesController < ApplicationController
  def index
    ...
    @venues = @q.result(:distinct => true).includes(:dishes, :best_dishes).page(params[:page]).per(10)
  ...
  def create
    ...
    @venue.venu_name = params[:venu_name]
    @venue.most_liked_dishes = params[:most_liked_dishes]
