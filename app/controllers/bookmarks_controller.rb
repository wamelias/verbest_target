class BookmarksController < ApplicationController
  ...
  def index
    ...
    @bookmarks = @q.result(:distinct => true).includes(:user, :venue, :dish, :cuisine).page(params[:page]).per(10)
  ...
  def create
    ...
    @bookmark.dish_name = params[:dish_name]
    @bookmark.venue_name = params[:venue_name]
